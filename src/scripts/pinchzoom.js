	...
	definePinchZoom = function () {
		...
		d.prototype = {
			...
			handleDragStart: function (a) {
				triggerEvent(this.el, this.options.dragStartEventName),
					"function" == typeof this.options.onDragStart && this.options.onDragStart(this, a),
					this.stopAnimation(),
			...
			handleZoomStart: function (a) {
				triggerEvent(this.el, this.options.zoomStartEventName),
					"function" == typeof this.options.onZoomStart && this.options.onZoomStart(this, a),
					this.stopAnimation(),
					(this.lastScale = 1),
					(this.nthZoom = 0),
			...
			handleZoom: function (a, b) {
				...
				(this.lastScale = b),
					(this.nthZoom += 1),
					3 < this.nthZoom && (this.scale(d, c), this.drag(c, this.lastZoomCenter)),
			...
			handleDoubleTap: function (a) {
				...
				this.hasInteraction ||
					...
					"function" == typeof this.options.onDoubleTap && this.options.onDoubleTap(this, a));
			},
			...
			scale: function (a, b) {
				(a = this.scaleZoomFactor(a)),
					this.addOffset({ x: (a - 1) * (b.x + this.offset.x), y: (a - 1) * (b.y + this.offset.y) }),
			...
			scaleZoomFactor: function (c) {
				...
				return (
					(this.zoomFactor *= c),
					(this.zoomFactor = a(this.options.maxZoom, b(this.zoomFactor, this.options.minZoom))),
					this.zoomFactor / d
				);
			},
			canDrag: function () {
					...
					f = function () {
						if (this.inAnimation) {
							var g = new Date().getTime() - e,
								h = g / a;
							g >= a
								? (b(1), d && d(), this.update(), this.stopAnimation(), this.update())
								: (c && (h = c(h)), b(h), this.update(), requestAnimationFrame(f));
						}
					}.bind(this);
			...
			update: function (a) {
				a && "resize" === a.type && (this.updateAspectRatio(), this.setupOffsets()),
					a && "load" === a.type && (this.updateAspectRatio(), this.setupOffsets());
				this.updatePlanned ||
		...
		var g = function (a, b) {
			var c = null,
				...
				g = function (a, d) {
					c !== a &&
						(c && !a && ("zoom" === c ? b.handleZoomEnd(d) : "drag" === c ? b.handleDragEnd(d) : void 0),
						"zoom" === a ? b.handleZoomStart(d) : "drag" === a ? b.handleDragStart(d) : void 0);
					c = a;
				},
				h = function (a) {
				...
				m = function (a) {
					...
					300 > f - e
						? (l(a),
						  b.handleDoubleTap(a),
						  "zoom" === c ? b.handleZoomEnd(a) : "drag" === c ? b.handleDragEnd(a) : void 0)
						: (b.isDoubleTap = !1);
					1 === d && (e = f);
				},
				n = !0;
					...
					function (a) {
						b.enabled &&
							...
							(n
								...
								: ("zoom" === c
										? 2 == f.length && 2 == a.touches.length && b.handleZoom(a, k(f, i(a.touches)))
										: "drag" === c
										? b.handleDrag(a)
										: void 0,
								  c && (l(a), b.update())),
